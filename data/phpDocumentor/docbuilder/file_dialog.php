...
$data_dir = dirname(__FILE__) . "/../..";
    ...
    */
    ...
    require_once( $data_dir . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file($data_dir . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = $data_dir . PATH_DELIMITER . 'PhpDocumentor/user';
    }
